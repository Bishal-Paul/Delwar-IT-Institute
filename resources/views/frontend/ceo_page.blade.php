...
<!--Start Leader area-->
<section class="ceo_area_start" data-background="{{url('frontend')}}/assets/images/leader__2.png" data-aos="fade-up">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-12">
                <div class="ceo_text_content">
                    <div class="ceo_spc_de">
                        ...
                        <p data-aos="fade-down">As one of the leading IT solution providers of Bangladesh,
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7 col-md-6 col-sm-12 col-12 d-flex justify-content-center flex-column order-md-2 order-sm-1 order-1">
                    <div class="overview_img text-center" data-aos="fade-down">
                        <img class="img-fluid" src="{{url('frontend')}}/assets/images/she_power_project.png" alt="she power project">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-7 col-md-6 col-sm-12 col-12">
                    <div class="overview_img text-center" data-aos="fade-up">
                        <img class="img-fluid" src="{{url('frontend')}}/assets/images/ui_ux.png" alt="Ui/UX project">
                    </div>
                </div>
        ...
        <div class="overview_content">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7 col-md-6 col-sm-12 col-12 order-md-2 order-sm-1 order-1">
                    <div class="overview_img text-center" data-aos="fade-down">
                        <img class="img-fluid" src="{{url('frontend')}}/assets/images/ledp.png" alt="ledp project">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                    <div class="memory_galery_content" data-aos="fade-up">
                        <div class="mory_image">
                            <img class="img-fluid" src="{{url('frontend')}}/assets/images/IMG-20210612-WA0026.jpg" alt="sylhetHi-tech park">
                            <div class="zoom_btn">
                                <a href="{{url('frontend')}}/assets/images/IMG-20210612-WA0026.jpg">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                    <div class="memory_galery_content" data-aos="fade-down">
                        <div class="mory_image">
                            <img src="{{url('frontend')}}/assets/images/FB_IMG_1611310931182.jpg" alt="sylhetHi-tech park">
                            <div class="zoom_btn">
                                <a href="{{url('frontend')}}/assets/images/FB_IMG_1611310931182.jpg">
                                    <i class="fas fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                    <div class="memory_galery_content" data-aos="fade-right">
                        ...
                        <div class="mory_image order-sm-2 order-1">
                            <img src="{{url('frontend')}}/assets/images/82595467_2511253482337093_6077068635791163392_n.jpg" alt="sylhet Hi-tech park">
                            <div class="zoom_btn">
                                <a href="{{url('frontend')}}/assets/images/82595467_2511253482337093_6077068635791163392_n.jpg">
                                    <i class="fas fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                    <div class="memory_galery_content" data-aos="fade-left">
                        ...
                        <div class="mory_image order-sm-2 order-1">
                            <img src="{{url('frontend')}}/assets/images/89693499_2568059970072481_7187847672181555200_n.jpg" alt="sylhetHi-tech park">
                            <div class="zoom_btn">
                                <a href="{{url('frontend')}}/assets/images/89693499_2568059970072481_7187847672181555200_n.jpg">
                                    <i class="fas fa-search-plus"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                    <div class="memory_galery_content" data-aos="fade-up">
                        <div class="mory_image">
                            <img src="{{url('frontend')}}/assets/images/IMG-20210612-WA0026.jpg" alt="sylhetHi-tech park">
                            <div class="zoom_btn">
                                <a href="{{url('frontend')}}/assets/images/IMG-20210612-WA0026.jpg">
                                    <i class="fas fa-search-plus"></i>
                                </a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="image" data-aos="zoom-in">
                        <img src="{{url('frontend')}}/assets/images/ab1.jpg" alt="" class="img-fluid">
                    </div>
                </div>
