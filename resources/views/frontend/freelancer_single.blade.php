        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="hero-content-area text-left">
                        <h4>Frelancers In Sylhet</h4>
                        <h1>{{$freelancer->name}}</h1>
                        <div class="p-text">
                            <p>{{$freelancer->post}}</p>
                        </div>
                        <p class="p-text1">{{$freelancer->summary}}</p>
            ...
            <div class="hero-thumb">
                <div class="hero-thumb-inner">
                    <img src="{{asset('thumbnails/'.$freelancer->image)}}" alt="{{$freelancer->name}}">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="experience-wrap">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="image">
                        <img src="{{asset('thumbnails/'.$freelancer->ex_img)}}" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <div class="single-wrap">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="image">
                        <img src="{{asset('thumbnails/'.$freelancer->success_img)}}" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
