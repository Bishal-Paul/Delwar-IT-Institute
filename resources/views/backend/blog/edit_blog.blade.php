                ...
                <div class="card-box">
                    ...
                    <form method="post" action="{{url('update-blog')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="title" class="form-control" value="{{$blog->title}}" name="title">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" data-role="tagsinput" value="{{$blog->tags}}" class="form-control tags @error('tags') is-invalid @enderror" name="tags">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="description" class="col-3 col-form-label">Description *</label>
                            <div class="col-9">
                                <textarea name="description" id="editor" class="my-editor form-control">{!!$blog->description!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="image" class="col-3 col-form-label">Preview Image</label>
                            <div class="col-9">
                                <img src="{{ asset('thumbnails/'.$blog->image) }}" width="200px" alt="{{ $blog->title }}">
                            </div>
                        </div>
                        <div class="form-group row">
