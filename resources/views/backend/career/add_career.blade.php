        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    @endif
                    <h4 class="header-title mb-4" style="float: left;">Add Jobs</h4>
                    <h4 class="header-title mb-4" style="float: right;"><a href="{{url('view-career')}}">View Jobs</a></h4><br>

                    <br><br>
                    <form method="post" action="{{url('post-career')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="description" id="editor" class="form-control @error('description') is-invalid @enderror" cols="30" rows="10"></textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="responsivilities" id="editor2" class="form-control @error('responsivilities') is-invalid @enderror" cols="30" rows="10"></textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="requirement" id="editor3" class="form-control @error('requirement') is-invalid @enderror" cols="30" rows="10"></textarea>
                                @error('requirement')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="experience" class="form-control @error('experience') is-invalid @enderror" name="experience">
                                @error('experience')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="shift" class="form-control @error('shift') is-invalid @enderror" name="shift">
                                @error('shift')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="salary" class="form-control @error('salary') is-invalid @enderror" name="salary">
                                @error('salary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="date" id="deadline" class="form-control @error('deadline') is-invalid @enderror" name="deadline">
                                @error('deadline')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="benefits" class="form-control" id="editor4"></textarea>
                                @error('benefits')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="aditional_note" class="form-control" id="" cols="10" rows="4"></textarea>
