        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    @endif
                    <h4 class="header-title mb-4" style="float: left;">Add Entrepreneur</h4>
                    <h4 class="header-title mb-4" style="float: right;"><a href="{{url('view-entrepreneur')}}">View Entrepreneur</a></h4><br>

                    <br><br>
                    <form method="post" action="{{url('post-entrepreneur')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="username" class="form-control @error('username') is-invalid @enderror" name="username" placeholder="username should be in lowercase">
                                @error('username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
