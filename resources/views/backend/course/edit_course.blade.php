                ...
                <div class="card-box">
                    ...
                    <form method="post" action="{{url('update-course')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" value="{{$course->title}}" id="title" class="form-control @error('title') is-invalid @enderror" name="title">
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" value="{{$course->slug}}" id="slug" class="form-control @error('slug') is-invalid @enderror" name="slug">
                                @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <img src="{{ asset('thumbnails/'.$course->image ?? 'NULL') }}" alt="{{ $course->name }}" width="100px">
                                @error('image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            <label for="fee" class="col-3 col-form-label">Course fee</label>
                            <div class="col-9">
                                <input type="text" id="fee" class="form-control @error('fee') is-invalid @enderror" name="fee" value="{{$course->fee}}">
                                @error('fee')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="class" class="form-control @error('class') is-invalid @enderror" name="class" value="{{$course->class}}">
                                @error('class')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
