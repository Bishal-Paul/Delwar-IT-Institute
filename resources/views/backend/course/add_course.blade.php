                ...
                <div class="card-box">
                    ...
                    <form method="post" action="{{url('post-course')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="career" id="editor" class="form-control @error('career') is-invalid @enderror" cols="30" rows="10"></textarea>
                                @error('career')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="fee" class="form-control @error('fee') is-invalid @enderror" name="fee">
                                @error('fee')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
